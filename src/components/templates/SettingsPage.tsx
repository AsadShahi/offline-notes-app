        ...
        reader.onload = (e) => {
            try {
                ...
                for (const note of importedNotes) {
                    // Ensure imported notes have required fields and correct types
                    if (
                        typeof note.title === 'string' &&
                        typeof note.content === 'string' &&
                        typeof note.isFavorite === 'boolean'
                    ) {
                        // Add new note using your store function
                        addNote({
                            title: note.title,
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm">
                    ...
                    <div className="px-6 py-5 space-y-6">
                        ...
                        {/* Success and Error Messages for Import */}
                        {showImportSuccess && (
                    ...
                    <div className="px-6 py-5">
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 text-sm pt-2">
                                ...
                                <span className="text-gray-500 dark:text-gray-400">
                                    {/* show just length of favorite notes */}
